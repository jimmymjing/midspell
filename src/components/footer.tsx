...
export default function Example() {
  return (
    <footer className="bg-[#1A1B1E]" aria-labelledby="footer-heading">
      <div className="pointer-events-none z-50 flex h-[100px] flex-col justify-center overflow-hidden bg-gradient-to-b from-black"></div>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 Vox Verbi, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
